...
function score = SymmetricBestPolyDice(inPoly,gtPoly)
% inPoly: table with polygons to be evaluated. 
% gtPoly: ground truth polygons.
% score: Symmetric Best Dice score for polygons.
    
    score1 = BestPolyScore(inPoly,gtPoly,@DiceScore);
    score2 = BestPolyScore(gtPoly,inPoly,@DiceScore);
