...
public class Main {	
	...
	public static void main( String args [] ) throws Exception {
		...
		String filterParameter = System.getProperty( "filterParameter", "190" );		
		...
		int filter = Integer.parseInt( filterParameter );
		...
		for( int base = 0 ; base < datasets.length ; base++ ) {
			...
			if( dSet != -1 ) {
				...
				solution.run( root, dataSetsInputPath, datasets[ base ] + "/", filter, dSet );								
